  ...
  <style>
    ...
    * {
    ...
    .about-hero::after {
      ...
      position: absolute;
      inset: 0;
      background: url('pci/download_(4).jpeg') center/cover no-repeat;
      opacity: .18;
      z-index: 0;
    }
    ...
    .hero-badge {
      ...
      background: rgba(212, 228, 212, .15);
      border: 1px solid rgba(212, 228, 212, .35);
      color: var(--sage);
      font-size: .72rem;
      letter-spacing: 3px;
    ...
    body.dark .about-footer * {
      color: rgba(212, 228, 212, .65) !important;
    }

    body.dark .about-footer .about-footer-link:hover,
    body.dark .about-footer .about-footer-social:hover {
      color: #fff !important;
    }
  </style>
  <script>
      ...
      <div class="row g-0 justify-content-center">
        <div class="col-6 col-md-3">
          <div class="metric-item">
            <h3>50+</h3>
            <p>Curated pieces across every room</p>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="metric-item">
        ...
        <div class="col-6 col-md-3">
          <div class="metric-item">
            <h3>95%</h3>
            <p>Customers who order a second time</p>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="metric-item">
            <h3>1 yrs</h3>
            <p>Average warranty on structural pieces</p>
          </div>
        </div>
      </div>
    </div>
