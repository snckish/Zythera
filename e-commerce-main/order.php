...
.sp-delivered,.sp-completed{background:#f0fdf4;color:#15803d;border:1px solid #bbf7d0;}
...
<div class="container py-4" style="max-width:900px;">
  <div class="page-header">
    ...
    <?php if ($viewAll): ?>
      <p class="text-muted mt-1" style="font-size:.85rem;">Track the status of your latest purchase and view details here.</p>
    <?php else: ?>
  ...
  <div class="alert-success-order" id="orderFlash" style="background:linear-gradient(135deg,#dcfce7,#bbf7d0);border:2px solid #86efac;border-radius:18px;padding:18px 24px;margin-bottom:24px;display:flex;align-items:center;gap:14px;box-shadow:0 4px 20px rgba(21,128,61,.12);">
  ...
  <div class="order-card" data-order-id="<?= htmlspecialchars($orderId) ?>">
    ...
    <div class="order-card-body">
      ...
      <div class="mt-3 d-flex flex-wrap gap-2">
        ...
        <?php if (!empty($shippingInfo['phone'])): ?><span class="delivery-chip"><i class="fas fa-phone" style="color:var(--mid);"></i><?= htmlspecialchars($shippingInfo['phone']) ?></span></span><?php endif; ?>
      </div>
      <?php endif; ?>
